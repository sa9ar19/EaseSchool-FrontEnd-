...
export const AllTeachers = () => {
  ...
  useEffect(() => {
    axios.get('http://localhost:8080/allTeacher')
      ...
      <div className="teacher-profile-container ">
        ...
        {items.map((item ) => (
          // <div key={item._id} className='teacher-profile-card'>
            <div key={item._id} className="flex items-center h-auto w-auto justify-center m-4">
              ...
              <div className="bg-white shadow-xl rounded-lg py-3">
                  <div className="photo-wrapper p-2">
                      <img className="w-32 h-32 rounded-full mx-auto" src="https://www.gravatar.com/avatar/2acfb745ecf9d4dccb3364752d17f65f?s=260&d=mp" alt="John Doe"></img>
                        ...
                        <div className="p-2">
                            <h3 className="text-center text-xl text-gray-900 font-medium leading-8">{item.teacher_first_name} {item.teacher_last_name}</h3>
                            ...
                            <div className="text-center my-3">
                                <button className="text-xs text-indigo-500 italic hover:underline hover:text-indigo-600 font-medium"  onClick={()=> {handleProfile(item._id)}}>View Profile</button>
                            </div>
